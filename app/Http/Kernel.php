...
use LaravelBlog\Http\Middleware\Admin;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        \LaravelBlog\Http\Middleware\CheckForMaintenanceMode::class,
    ...
    protected $routeMiddleware = [
        ...
        'admin' => \LaravelBlog\Http\Middleware\Admin::class // Admin Middleware To Hide some functionalities from non admin users and non athenticated users
    ];
}
